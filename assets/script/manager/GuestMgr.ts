import { _decorator, CCString, Collider, Component, instantiate, Node, Prefab, Quat, random, randomRangeInt, v3, Vec3 } from 'cc';
            ...
            if (firstGuest) {
                if (firstGuest.isArrived()) {
                    ...
                    if (firstGuest.moveBack()) {
                        ...
                        if (this.sfxName.length > 0 && random() < 0.1)
                            SoundMgr.playSound(this.sfxName);
                    }
                }
            }
